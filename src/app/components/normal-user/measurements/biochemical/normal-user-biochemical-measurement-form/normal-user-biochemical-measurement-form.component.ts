...
@Component({
  selector: 'app-normal-user-biochemical-measurement-form',
  standalone: true,
  imports: [
    ReactiveFormsModule,
    MatFormFieldModule,
  ...
  templateUrl: './normal-user-biochemical-measurement-form.component.html',
  styleUrl: './normal-user-biochemical-measurement-form.component.css'
})
export class NormalUserBiochemicalMeasurementFormComponent {
  ...
  submit(formValue: any) {
    ...
    this.measurementService.crudUserMeasurementRequest('post', userId, 'biochemical', null, biochemicalMeasurement).subscribe(() => {

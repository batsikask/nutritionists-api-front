...
@Component({
  selector: 'app-normal-user-biochemical-measurement-edit',
  standalone: true,
  imports: [
    ReactiveFormsModule,
    MatFormFieldModule,
  ...
  templateUrl: './normal-user-biochemical-measurement-edit.component.html',
  styleUrl: './normal-user-biochemical-measurement-edit.component.css'
})
export class NormalUserBiochemicalMeasurementEditComponent {
  ...
  submit(formValue: any) {
    ...
    this.measurementService.crudUserMeasurementRequest('patch', userId, 'biochemical', biochemicalMeasurementId, updatedBiochemicalMeasurement).subscribe(() => {
